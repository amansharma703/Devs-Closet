    ...
    return (
        <header class='text-gray-600 body-font '>
            <div class='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-start md:items-center'>
                ...
                <nav class='md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base md:text-xl justify-center'>
                    <Link href='/'>
                        <a class='mr-5 hover:text-gray-900'>Tshirts</a>
                    </Link>
                    <Link href='/'>
                        <a class='mr-5 hover:text-gray-900'>Hoddies </a>
                    </Link>
                    <Link href='/'>
